...
export const EmployeeTimeSheets = ({ employeeId, costcodeData, jobsiteData }: Props) => {
    ...
    return (
        ...
        <div className="flex flex-col py-5 px-2 w-11/12 mx-auto h-1/4 border-2 border-black rounded-2xl text-white text-3xl">
            ...
            {/* This form listens for a change to date and then starts the data fetching, stores two values to process that action*/}
            ...
            <EditWork timesheetData={timesheets} edit={edit} costcodesData={costcodeData} jobsitesData={jobsiteData} />
        </div>
        </div>
    );
    };
