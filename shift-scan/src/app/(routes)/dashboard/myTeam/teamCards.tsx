...
export default async function TeamCards() {
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center p-5 rounded-2xl text-4xl font-bold">
            ...
            <div key={employee.id} className="w-full flex flex-row items-center rounded-2xl">
                ...
                <h2 className="text-4xl">{employee.employee.first_name} {employee.employee.last_name}</h2>
                </div>
            </div>
            </TeamInfoButton>
            ))}
