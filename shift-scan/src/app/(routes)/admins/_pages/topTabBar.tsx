  ...
  return (
    <Holds className="h-full col-span-10 bg-white bg-opacity-20">
      <Grids cols="8" gap="2" className="w-full flex md:grid items-center">
        ...
        <Holds
          position="row"
          className="bg-white h-full col-span-1 px-1 rounded-r-[10px] min-w-[100px]"
        >
          <Images
            titleImg="/logo.svg"
            titleImgAlt="Logo"
          ...
          />
          {screenWidth < 1000 ? null : ( // If screen width < 1200px, show only the image
            <>
              {userImage ? (
                <img
                  src={userImage}
        ...
        <Holds className="bg-white col-span-4 rounded-[10px] bg-opacity-20 py-2 hidden md:flex h-[45px] justify-center items-center">
          <Texts size="p6">
            Hey {firstName} {lastName}, welcome to Shift Scan!
          </Texts>
        </Holds>
