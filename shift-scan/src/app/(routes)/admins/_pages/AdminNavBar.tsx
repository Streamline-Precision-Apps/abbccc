          ...
          {isHomePage ? (
            screenWidth < 1300 ? (
              ...
              <Images
                ...
                className="m-auto h-[40px] min-w-[60px]"
              />
            ) : (
              // Default full view
              <Holds
            ...
            <Images
              titleImg="/home.svg"
              titleImgAlt="Home Icon"
              className="m-auto h-[40px] min-w-[50px]"
            />
          )}
        </Buttons>
