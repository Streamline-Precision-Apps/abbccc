        ...
        <div className="w-full flex flex-col border-b border-gray-100 pb-3 relative">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full flex flex-row gap-x-2 items-center ">
              {loading ? (
                <>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">{`ID: ${timesheetId}`}</span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">
                    User...
                  </span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">{`Created`}</span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">
                    Status...
                  </span>
                </>
                ...
                <>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">{`ID: ${timesheetId}`}</span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">{`${form?.User?.firstName} ${form?.User?.lastName}`}</span>
                  <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-lg">
                    {`Created: ${form?.createdAt ? format(new Date(form.createdAt), "MMM d, yyyy h:mm a") : "Unknown"}`}
                  </span>
                  <span
              ...
              >
                ...
                <div className="border rounded-lg p-4 bg-gray-50 mt-4">
                  ...
                  <p className="text-xs text-gray-600 mb-2">
                    Please provide a reason for the changes you&apos;re making
                    to this timesheet.
                  </p>
                  <Textarea
                    value={changeReason}
