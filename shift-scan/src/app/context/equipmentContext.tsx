...
interface ScanDataEQContextProps {
    scanEQResult: scanEQResult | null;
    setscanEQResult: (result: scanEQResult | null) => void;
}

interface scanEQResult {
    data: string;
}

const ScanDataEQContext = createContext<ScanDataEQContextProps | undefined>(undefined);

export const ScanDataEQProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
