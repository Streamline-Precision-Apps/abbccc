...
return (
    ...
    {imageList.map((img, idx) => {
        ...
        return (
        <>
        <Holds background={bgColor as "orange" | "white"} className="h-full rounded-[10px]" key={idx}>
            <Holds position={"row"} className="flex flex-row items-center justify-center gap-1" key={idx}>
