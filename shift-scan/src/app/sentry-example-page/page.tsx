    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://streamline-precision-llc-el.sentry.io/issues/?project=4510041616613376">Issues Page</a>.
