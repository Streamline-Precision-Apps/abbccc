...
interface TabProps extends HTMLAttributes<HTMLElement>, VariantProps<typeof TabVariants> {
}
        ...
        <div className="py-4 max-w[400px]">
          ...
          <Sections variant={"tab"} size={"default"}>
            ...
            <Contents>
              <Expands title="Current Equipment" divID="1">
                ...
                <Forms> 
                  ...
                  <Inputs variant={"default"} value={"null"}></Inputs>
                  <Buttons variant={"default"} size={"default"}>Button 1</Buttons>
                </Forms>
              </Expands>
              ...
              <Forms> 
                ...
                <Inputs variant={"default"}></Inputs>
                <Buttons variant={"default"} size={"default"}>Button 2</Buttons>
              </Forms>
            </Expands>
            ...
            <Forms> 
              ...
              <Inputs variant={"default"}></Inputs>
              <Buttons variant={"default"} size={"default"}>Button 3</Buttons>
            </Forms>
          </Expands>
          </Contents>
            }
