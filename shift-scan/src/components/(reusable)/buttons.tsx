...
const Buttons: FC<ButtonProps> = ({className, background, position, size, href, id, ...props}) => {
    ...
    return (
      <button onClick={() => {pageAction()}} className={cn(ButtonVariants({background, size, position, className}))} {...props}/>
    )
}
