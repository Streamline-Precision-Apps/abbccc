...
CREATE TABLE "PendingApproval" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "approvedAt" DATETIME,
    CONSTRAINT "PendingApproval_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "PendingApproval_approvedById_fkey" FOREIGN KEY ("approvedById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "PendingApproval_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "PendingApproval_jobsiteId_fkey" FOREIGN KEY ("jobsiteId") REFERENCES "Jobsite" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "AuditLog" (
    ...
    CONSTRAINT "AuditLog_jobsiteId_fkey" FOREIGN KEY ("jobsiteId") REFERENCES "Jobsite" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "EmployeeEquipmentLog" (
    ...
    CONSTRAINT "EmployeeEquipmentLog_jobsiteId_fkey" FOREIGN KEY ("jobsiteId") REFERENCES "Jobsite" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "EquipmentHauled" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "jobSiteId" TEXT,
    CONSTRAINT "EquipmentHauled_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "Jobsite" (
    ...
    CONSTRAINT "Jobsite_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "TimeSheet" (
    ...
    CONSTRAINT "TimeSheet_jobsiteId_fkey" FOREIGN KEY ("jobsiteId") REFERENCES "Jobsite" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "TascoLog" (
    ...
    CONSTRAINT "TascoLog_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE "TruckingLog" (
    ...
    CONSTRAINT "TruckingLog_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
